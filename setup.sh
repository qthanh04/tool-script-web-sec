...
show_download_instructions() {
    ...
    echo ""
    echo -e "${GREEN}1. Download Complete Package (Recommended):${NC}"
    echo "   wget https://github.com/qthanh04/tool-script-web-sec/releases/download/v1.0/OWASP_Labtainer_Complete_Package_v1.0.tar.gz"
    echo "   tar -xzf OWASP_Labtainer_Complete_Package_v1.0.tar.gz"
    echo ""
